        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <article class="news-item">
                <a href="<?php get_url('event','care'); ?>">
                    <h3>GUERRES INTIMES == 
	                    FOSSE AUX MORTS CAR LA VEILLE CEST LA FETE DES MORTS</h3>
                    <p class="meta">c a r e ~ a url party <br>
	                    for this c a r e #9 the care collective is collaborating with our friends of the Clusterduck Collective and panke.gallery for their <em> Internet Fame Embassy</em> in Frame of </a> <a href="http://thewrong.org"><strong>The Wrong Digital Biennale</strong></a>  
	                                 <br />11.01.2017 at 19 p.m. - open end - free entry</p>
	                                 <div class="image-wrapper.fit-height">
                            <a href="<?php get_url('event','care'); ?>"><img src="/img/care/PANKE_WEBSITE_COVER_01.png"></a>
                            <p>flyer by Valentin Amossé</p>
                        </div> 
                        <p>LINEUP == ANTONIA XM :: RUI HO :: Ship Sket :: Mara Oscar Cassiani :: S x m b r a b2b Shivo :: Fatma Pneumonia :: Yung Soft
