    ...
    ================================================== -->
         ...
         <section class="further">  <!-- Contact info and opening times -->
            <div class="row">
                <div class="col-md-4 col-sm-4 col-xs-12">
                    ...
                    <h3>Opening hours</h3>
                        <h4>During exhibitions</h4>
                        <p>Thu, Fri 1 pm&thinsp;-&thinsp;7 pm<br />
	                        and Sat 3 pm&thinsp;-&thinsp;8 pm<br />
						   and for special events</p>
                        <h4>Outside exhibition dates</h4>
    ...
    ================================================== -->
        ...
        <section class="further">  <!-- How to find us -->
            <div class="row">
                <div class="col-md-4 col-sm-4 col-xs-12">
                    <h3>How to find us</h3>
                </div>
                <div class="col-md-8 col-sm-8 col-xs-12">
                    <p><strong>arriving by public transport</strong>
        ...
        <section class="further">  <!-- Imprint and disclaimer -->
            <div class="row">
                <div class="col-md-4 col-sm-4 col-xs-12">
                    <h3>Impressum</h3>
                    <p>
                        <br />panke.gallery – Verein für künstlerisch-kulturelle Bildung e.V.<br />
                        Gerichtstr. 23 · Hof V<br />
                        13347 Berlin<br />

                        <br /><strong>Redaktionell verantwortl. gem. § 5 TMG</strong><br />
                        Robert Sakrowski<br />

                        <br /><strong>Amtsgericht-Registernummer</strong><br />
                        123-456-79-123-456<br />
                    </p>
                </div>
                <div class="col-md-8 col-sm-8 col-xs-12">
