...
<section>
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <article class="news-item">
                <a href="https://netzkunst.berlin">
                    <h3>net.art and the gallery system</h3>
                    <p>15:00&thinsp;-&thinsp;17:00 workshop<br>
                    Peggy Sylopp<br>
                    17:00&thinsp;-&thinsp;19:00 talk<br>
                    Ché Zara Blomfield<br>
                    19:00&thinsp;-&thinsp;21:00 panel<br>
                    Harm van den Dorpel, Jonas Lund (Moderation: Alexander Scrimgeour)</p>
                    <p class="meta">3 November 2018</p>
                </a>
            </article>
            ...
            <article class="news-item">
                <a href="https://netzkunst.berlin">
                    <h3>net.culture</h3>
                    <p>15:00&thinsp;-&thinsp;19:00 workshop<br>
                    Aram Bartholl<br>
                    19:00&thinsp;-&thinsp;21:00 panel<br>
                    Cornelia Sollfrank, OMSK Social  CLub (Moderation: Tabea Rossol)</p>
                    <p class="meta">17 November 2018</p>
                </a>
            </article>

            <article class="news-item">
                <a href="<?php get_url('exhibition','MaxGrauStream'); ?>">
                    <h3>[workingtitle]<br>[sudo keylogger /Users/machs/Büro/Ausstellungen/2018/2018_Panke/log.txt]</h3>
                    <p>a web performance by Max Grau</p>
                    <p class="meta">tba - annouced 20 October</p>
                </a>
            </article>
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
	        <article class="news-item">
                <a href="https://netzkunst.berlin">
                    ...
                    <p>17:00&thinsp;-&thinsp;19:00 discussion<br>
                    Internationale Stadt Berlin , Sebastian Lüdgert, Eva Grubinger<br>
                    19:00&thinsp;-&thinsp;21:00 lecture<br>
                    Annet Dekker</p>
                    <p class="meta">13 October 2018</p>
                </a>
            </article>

            <article class="news-item">
                <a href="<?php get_url('event','eGames_6'); ?>">
				    ...
				    <p class="meta">19 June 2018</p>
            </article>

	        <article class="news-item">
                <a href="<?php get_url('event','eGames_5'); ?>">
                    ...
                    <p class="meta">11 July 2018 </p>
                </a>
            </article>

            <article class="news-item">
                <a href="<?php get_url('event','eGames_4'); ?>">
                    ...
                    <p class="meta">27 June 2018 </p>
                </a>
            </article>


	         <article class="news-item">
                <a href="<?php get_url('event','eGames_3'); ?>">
            ...
            <article class="news-item">
	         ...
	         <article class="news-item">
              <a href="<?php get_url('event','eGames_two'); ?>">
                <h3>eGames - die Kunst des ernsten Spiels – 2</h3>
                    <p>FILMSCREENING: Codes of Honor (2011) by  Jon Rafman &mdash; The Space Invaders: In Search of Lost Time (2012) by Jeff Von Ward<br>
                    ARTIST PRESENTATION: Omsk Social Club (UK)
                  </p>
                    <p class="meta">30 May 2018 from 21:00&thinsp;–&thinsp;22.00 | after-party with PS+ Gaming DJ Night (free entry)</p>
                </a>
            </article>

	        <article class="news-item">
                <a href="<?php get_url('event','cryptorave'); ?>">
                    <h3>cryptorave</h3>
                    ...
                    <p class="meta">09 May 2018 from 21:00&thinsp;–&thinsp;04.00</p>
                </a>
            </article>
			<article class="news-item">
                <a href="<?php get_url('event','eGames_one'); ?>">
                    ...
                    <p class="meta">25 April 2018 from 19:00&thinsp;–&thinsp;22.00 | after-party with PS+ Gaming DJ Night</p>
                </a>
            </article>
	        ...
	        <article class="news-item">
                <a href="<?php get_url('event','soundnight04'); ?>">
                    ...
                    <p class="meta">31. March 2018 from 22:00&thinsp;–&thinsp;open end</p>
                </a>
            </article>
            ...
            <article class="news-item">
                <a href="<?php get_url('event','soundnight03'); ?>">
                    ...
                    <p class="meta">03 Feburary 2018 from 22:00&thinsp;–&thinsp;open end</p>
                </a>
            </article>

	        <article class="news-item">
                <a href="<?php get_url('event','veryParty'); ?>">
                    <h3>Much Fame, Very Party</h3>
                    <p>Event in the context of Internet Fame exhibition</p>
                    <p class="meta">20 January 2018 from 19:00&thinsp;–&thinsp;open end</p>
                </a>
            </article>


            <article class="news-item">
                <a href="<?php get_url('event','calendarLaunch'); ?>">
                    <h3>About Us | 2018 calendar launch</h3>
                    <p>Launch of the new calendar edition 2018 by Niko Princen</p>
                    <p class="meta">29 November 2017 from 19:00&thinsp;–&thinsp;22:00</p>
                </a>
            </article>

            <article class="news-item">
                <a href="<?php get_url('event','soundnight02'); ?>">
                    <h3>SOUND NIGHT II</h3>
                    <p>Live performances by: Candy Blissett, Robert Lippok, Rattenjunge, Blade Ronny (aka ChiChimini | Mattow)</p>
                    <p class="meta">24 November 2017 from 21:00&thinsp;–&thinsp;open end</p>
                </a>
            </article>

            <article class="news-item">
                <a href="<?php get_url('event','care'); ?>">
                    ...
                    <p class="meta">1 November 2017 from 19:00&thinsp;–&thinsp;open end</p>
                </a>
            </article>
            ...
            <article class="news-item">
                <a href="<?php get_url('event','express'); ?>">
                    ...
                    <p class="meta">09 September 2017 from 19:00&thinsp;–&thinsp;21:00</p>
                </a>
            </article>
			...
			<article class="news-item">
                <a href="<?php get_url('event','LAplaysitself'); ?>">
                    ...
                    <p>performance by <strong>Sebastian L&uuml;tgert</strong></p>
                    <p class="meta">29 April 2017 from 17:00&thinsp;–&thinsp;21:00 and 06 May 2017 from 17:00&thinsp;–&thinsp;21:00</p>
            ...
            <article class="news-item">
                <a href="<?php get_url('event','leisure'); ?>">
                    ...
                    <p>with <strong>Sebastian Schmieg</strong> and <strong>Silvio Lorusso</strong></p>
                    <p class="meta">11 May 2017 at 18:00&thinsp;–&thinsp;21:00</p>
                </a>
            </article>
            ...
            <article class="news-item">
                <a href="<?php get_url('event','soundnight01'); ?>">
                    ...
                    <p class="meta">30 March 2017 from 21:00&thinsp;–&thinsp;open end after opening</p>
                </a>
            </article>

            <article class="news-item">
                <a href="<?php get_url('event','panel-curation'); ?>">
                    <h3>Kuratieren als Netzwerktechnik</h3>
                    <p>Panel with Karen Archey, Susanne Jaschko and Holger Friese. Moderation Sakrowski</p>
                    <p class="meta">11 February 2017 at 17:00</p>
                </a>
            </article>

            <article class="news-item">
                <a href="<?php get_url('event','annet-dekker'); ?>">
                    <h3>Net art and the need for an expanded practice of conservation</h3>
                    <p>Lecture by Annet Dekker in the frame of our exhibition: <em> Netzkunst im Berlin der 1990er – eine kritische Bestandsaufnahme</em></p>
                    <p class="meta">3 February 2017 at 15:00&thinsp;–&thinsp;17:00</p>
                </a>
            </article>
